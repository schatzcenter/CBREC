...
load_data <- function(id, treatment, f_piled, f_scattered, burn_type, biomass_collection, pulp_market, tile_number) {
        ...
        residue_path <- list("No_Action" = "CBREC-Fire/input/residue/NoAction.csv",
                             "Clearcut" = "CBREC-Fire/input/residue/Remove100Percent.csv",
                             "20_Thin_From_Above" = "CBREC-Fire/input/residue/ThinFromAboveRemove20PercentBA.csv",
                             "40_Thin_From_Above" = "CBREC-Fire/input/residue/ThinFromAboveRemove40PercentBA.csv",
                             "60_Thin_From_Above" = "CBREC-Fire/input/residue/ThinFromAboveRemove60PercentBA.csv",
                             "80_Thin_From_Above" = "CBREC-Fire/input/residue/ThinFromAboveRemove80PercentBA.csv",
                             "20_Thin_From_Below" = "CBREC-Fire/input/residue/ThinFromBelowRemove20PercentBA.csv",
                             "40_Thin_From_Below" = "CBREC-Fire/input/residue/ThinFromBelowRemove40PercentBA.csv",
                             "60_Thin_From_Below" = "CBREC-Fire/input/residue/ThinFromBelowRemove60PercentBA.csv",
                             "80_Thin_From_Below" = "CBREC-Fire/input/residue/ThinFromBelowRemove80PercentBA.csv",
                             "20_Proportional_Thin" = "CBREC-Fire/input/residue/ThinProportionalRemove20PercentBA.csv",
                             "40_Proportional_Thin" = "CBREC-Fire/input/residue/ThinProportionalRemove40PercentBA.csv",
                             "60_Proportional_Thin" = "CBREC-Fire/input/residue/ThinProportionalRemove60PercentBA.csv",
                             "80_Proportional_Thin" = "CBREC-Fire/input/residue/ThinProportionalRemove80PercentBA.csv",
                             "Standing_Dead" = "CBREC-Fire/input/residue/Snags.csv")
        
        # file path to fuel proportion table, used to divide residue ## V2 with values for tenK fuels MB 6/26/19
        fuel_prop_path <- "CBREC-Fire/input/FCCS/FCCS_fuel_load_proportions.csv"
        
        # file path to FCCS fuelbed table
        fuelbed_path <- "CBREC-Fire/input/FCCS/FCCS_fuelbed.csv"
        
        # load tabulated spatial data for the tile
        rdf <- readRDS(paste0("CBREC-Fire/input/tiles/tabulated_spatial_data/",
                              tile_number, ".rds"))
