...
FCCS_prop <- FCCS %>%
        mutate(branch_total = rowSums(dplyr::select(., c("one_hr_sound",
                                                  "ten_hr_sound",
                                                  "hun_hr_sound"))),
               ge4lt9_total = oneK_hr_sound,
               ge9_total = rowSums(dplyr::select(., c("tenK_hr_sound","tenK_hr_rotten",
                                               "tnkp_hr_sound","tnkp_hr_rotten")))) %>%
        transmute(fuelbed_number = fuelbed_number,
                  ...
                  hun_hr_sound_prop = zero_div(hun_hr_sound,
                                               branch_total),
                  oneK_hr_sound_prop = 1,#zero_div(oneK_hr_sound,
                                                #ge4lt9_total),
                  tenK_hr_sound_prop = zero_div(tenK_hr_sound+tenK_hr_rotten,
                                                ge9_total),
                  tnkp_hr_sound_prop = zero_div(tnkp_hr_sound+tnkp_hr_rotten,
                                                ge9_total))
```
