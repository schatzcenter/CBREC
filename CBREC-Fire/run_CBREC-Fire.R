...
###############################   MB 6/24/19   ###############################
## Before running this function check the spatial input files in lad_data.R and the write location defined in save_output.R
## Both of these functions may change through development and testing
##############################################################################